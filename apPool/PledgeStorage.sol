...
contract AsoPoolData {
    ...
    function pushPledges(address useraddress) public onlyFactory returns (bool) {
        if (pledges[useraddress].amount == 0 && pledges[useraddress].ownerGains == 0 && pledges[useraddress].availableAso == 0) {
    ...
    function getPledgeInfo(address useraddress) public returns(uint256,uint256,uint256,uint256){
